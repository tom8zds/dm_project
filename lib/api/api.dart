...
class Api {
  ...
  /// 漫画专题
  static String comicCollection({int page = 0}) {
  ...
  static String comicRank(
      {int tag = 0, int timeRange = 0, int orderType = 0, int page = 0}) {
    return "$apiHost/rank/$tag/$timeRange/$orderType/$page.json?${defaultParameter()}";
  }
  ...
  /// 漫画专题详情
  static String comicCollectionContent(int collectionId) {
    return "$apiHost/subject/$collectionId.json?${defaultParameter()}";
  }
